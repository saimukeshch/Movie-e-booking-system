...
SECRET_KEY = 'django-insecure-)&tpdch8!k6+--va&u4i)n_==9$*e8^a96c6_ei(izr(a&#rq3'
...
ENCRYPT_KEY = b'i0J23xrRFIXt-hwxapv9tc0EJgcNeKrmrXNB5ATcEI0='
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'home', 'templatetags'),
        ],
        'OPTIONS': {
            'context_processors': [
